...
import { documentCategories } from "@/lib/mock-data/documents";
...
export default function DocumentsPage() {
  ...
  async function handleUpload(file: File) {
    ...
    formData.append("category", category === "All" ? "Policy" : category);
          ...
          <>
            <input
              ...
              onChange={(e) => {
                ...
                if (file) void handleUpload(file).catch(console.error);
                e.target.value = "";
              }}
            />
